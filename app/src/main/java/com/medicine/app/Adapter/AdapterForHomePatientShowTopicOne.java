...
public class AdapterForHomePatientShowTopicOne extends RecyclerView.Adapter<AdapterForHomePatientShowTopicOne.viewHolder> {

    private ShowTopicRecyclerHomePatientOneBinding binding;
    private Context context;
    private List<TopicPatient> list;

    public AdapterForHomePatientShowTopicOne() {
    }

    public AdapterForHomePatientShowTopicOne(Context context, List<TopicPatient> list) {
    ...
    @NonNull
    @Override
    public AdapterForHomePatientShowTopicOne.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
